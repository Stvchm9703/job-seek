...
// UpdateUserSearchPerfence implements UpdateUserSearchPerfence from UserManagementServiceServer
// generated by protoc-gen-go-grpc.UserManagementServiceServer
func (s UserManagementServiceServerImpl) UpdateUserSearchPerfence(ctx context.Context, req *protos.UserSearchPerfence) (*protos.UserResponse, error) {
  // todo()
