...
// SaveUserSearchPerfence implements SaveUserSearchPerfence from UserManagementServiceServer
// generated by protoc-gen-go-grpc.UserManagementServiceServer
func (s UserManagementServiceServerImpl) SaveUserSearchPerfence(ctx context.Context, req *protos.UserSearchPerfence) (*protos.UserResponse, error) {
  // todo()
