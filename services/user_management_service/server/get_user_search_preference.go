...
// GetUserSearchPreference implements GetUserSearchPreference from UserManagementServiceServer
// generated by protoc-gen-go-grpc.UserManagementServiceServer
func (s UserManagementServiceServerImpl) GetUserSearchPreference(ctx context.Context, req *protos.GetUserRequest) (*protos.UserSearchPreference, error) {
  // todo()
