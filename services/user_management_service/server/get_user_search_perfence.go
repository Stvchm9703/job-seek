...
// GetUserSearchPerfence implements GetUserSearchPerfence from UserManagementServiceServer
// generated by protoc-gen-go-grpc.UserManagementServiceServer
func (s UserManagementServiceServerImpl) GetUserSearchPerfence(ctx context.Context, req *protos.GetUserRequest) (*protos.UserSearchPerfence, error) {
  // todo()
