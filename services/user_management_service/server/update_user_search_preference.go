...
// UpdateUserSearchPreference implements UpdateUserSearchPreference from UserManagementServiceServer
// generated by protoc-gen-go-grpc.UserManagementServiceServer
func (s UserManagementServiceServerImpl) UpdateUserSearchPreference(ctx context.Context, req *protos.UserSearchPreference) (*protos.UserResponse, error) {
  // todo()
