...
// SaveUserAccount implements SaveUserAccount from UserManagementServiceServer
// generated by protoc-gen-go-grpc.UserManagementServiceServer
func (s UserManagementServiceServerImpl) SaveUserAccount(ctx context.Context, req *protos.UserAccount) (*protos.UserResponse, error) {
  // todo()
