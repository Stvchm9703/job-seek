...
// GetJobApply implements GetJobApply from JobExtendsionServiceServer
// generated by protoc-gen-go-grpc.JobExtendsionServiceServer
func (s JobExtendsionServiceServerImpl) GetJobApply(ctx context.Context, req *protos.GetJobApplyRequest) (*protos.JobApply, error) {
	// todo()
